          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="leading-tight">
                <span className="block font-heading font-bold text-lg text-background">SUDHA</span>
                <span className="block text-[11px] text-background/70 font-medium">
                  सुधा • Healthcare Safety Platform
                </span>
              </div>
            </div>
